...
/// # Examples
/// ```
/// use QuantumTimeSandwich::state_ops::matrix_ops::from_reals;
/// use QuantumTimeSandwich::state_ops::measurement_ops::measure_prob;
///
...
/// ```
/// use QuantumTimeSandwich::state_ops::matrix_ops::from_reals;
/// use QuantumTimeSandwich::state_ops::measurement_ops::soft_measure;
///
/// // Make the state |10>, index 0 is always |1> and index 1 is always |0>
/// let input = from_reals(&[0.0, 0.0, 1.0, 0.0]);
///
