...
mod tests {
    ...
    #[bench]
    fn bench_large_ones_QuantumTimeSandwich(b: &mut Bencher) {
        let n = 20;
    ...
    #[bench]
    fn bench_two_QuantumTimeSandwich_series(b: &mut Bencher) {
        let n = 12;
    ...
    #[bench]
    fn bench_two_QuantumTimeSandwich_multi(b: &mut Bencher) {
        let n = 12;
    ...
    #[bench]
    fn bench_three_QuantumTimeSandwich_series(b: &mut Bencher) {
        let n = 12;
    ...
    #[bench]
    fn bench_three_QuantumTimeSandwich_multi(b: &mut Bencher) {
        let n = 12;
    ...
    #[bench]
    fn bench_twelve_QuantumTimeSandwich_series(b: &mut Bencher) {
        let n = 12;
    ...
    #[bench]
    fn bench_twelve_QuantumTimeSandwich_multi(b: &mut Bencher) {
        let n = 12;
